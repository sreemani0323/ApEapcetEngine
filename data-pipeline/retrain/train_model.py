"""
AP EAPCET ML Model Training Script (Retraining Pipeline)
=========================================================
Connects to PostgreSQL, extracts cutoff data from 2022 and 2024,
engineers features (district, college_age, historical trends,
group medians), and trains a LightGBM model to predict cutoff ranks.
...
Usage:
    # Set DB_URL environment variable first
    export DB_URL="postgresql+psycopg2://postgres:yourpassword@localhost:5432/eapcet_db"
